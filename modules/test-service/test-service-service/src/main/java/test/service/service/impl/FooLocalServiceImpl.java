 ...
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the <code>test.service.service.FooLocalService</code> interface.
 *
 * <p>
 ...
 */
@Component(
	property = "model.class.name=test.service.model.Foo",
...
public class FooLocalServiceImpl extends FooLocalServiceBaseImpl {
	...
	public Foo deleteFoo3S(long fooId) throws PortalException {
		return fooPersistence.remove(fooId);
	}
